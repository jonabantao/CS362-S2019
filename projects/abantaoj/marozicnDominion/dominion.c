...
/* Pick 5 of these cards including smithy and adventurer and introduce bugs - take those 5 and make own functions within the code base */ 
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      adventurerCard(card, choice1, choice2, choice3, state, handPos, &bonus, currentPlayer); 

      return 0; 

    /*
    // Old code base within switch statment 
   ...
   */
    ...
    case council_room:
      ...
      councilRoomCard(card, choice1, choice2, choice3, state, handPos, &bonus, currentPlayer); 

      return 0; 

    /*
    // Original Code Council Room
      //+4 Cards
      for (i = 0; i < 4; i++)
   {
     drawCard(currentPlayer, state);
   ...
   */ 
      ...
      for (i = 0; i < state->handCount[currentPlayer]; i++)
   {
    ...
    case smithy:
      ...
      smithyCard(card, choice1, choice2, choice3, state, handPos, &bonus, currentPlayer);
   ...
   */
    ...
    case village:
      ...
      villageCard(card, choice1, choice2, choice3, state, handPos, &bonus, currentPlayer); 
   ...
   if (supplyCount(estate, state) > 0){
    ...
    case great_hall:
      ...
      greatHallCard(card, choice1, choice2, choice3, state, handPos, &bonus, currentPlayer); 

      return 0; 

      /*
      // original great hall code 
      //+1 Card
      drawCard(currentPlayer, state);
